                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4'>
                    ...
                    <div className='sm:col-span-2'>
                        <div className='mt-2.5 '>
                            <textarea placeholder='Your Message' name="message" id="" className='bg-[#161616] w-full px-4 py-4 text-gray-400 placeholder-gray-400 border
                    ...
                    <div className='sm:col-span-2'>
                        <button type='submit' className='text-xl w-full p-4 mt-2 font-semibold
                         text-white bg-primary-color rounded-md'>
                            Send
